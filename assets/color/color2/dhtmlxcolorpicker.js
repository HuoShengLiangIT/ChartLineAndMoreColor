...
if (typeof(dhtmlxEvent.initTouch) == "undefined") {
    dhtmlxEvent.initTouch = function() {
        ...
        var e;
        var b, a;
        dhtmlxEvent(document.body, "touchstart",
        function(f) {
        ...
        dhtmlxEvent(document.body, "touchend",
        function(f) {
            if (d) {
                window.clearTimeout(d);
                d = e = false
...
function dhtmlXColorPicker(g) {
    ...
    this._doOnChangeHSL = function() {
        var j = parseInt(e._controllerNodes.hue.value),
        i = parseInt(e._controllerNodes.sat.value),
        h = parseInt(e._controllerNodes.lum.value),
        k;
    ...
    this._doOnChangeRGB = function() {
        var k = parseInt(e._controllerNodes.red.value),
        j = parseInt(e._controllerNodes.green.value),
        h = parseInt(e._controllerNodes.blue.value),
        i;
...
dhtmlXColorPicker.prototype._addNode = function(e, g, f) {
    ...
    a = {
        node: b,
        valueColor: (g != undefined) ? g: c || b,
        valueCont: (f != undefined) ? f: b,
        conf: {
...
dhtmlXColorPicker.prototype._refreshValueByInput = function() {
    var b = this.activeNode.valueCont.value,
...
dhtmlXColorPicker.prototype._refreshContrast = function() {
    ...
    if (c && c <= 9) {
        ...
        var b = this.colorAIP.rgb2hex({
            r: Math.round(255 * d.r),
            g: Math.round(255 * d.g),
            b: Math.round(255 * d.b)
        });
        var a = this.colorAIP.rgb2hex({
...
dhtmlXColorPicker.prototype.Memory = function(c) {
    ...
    this._findMemoryControllers = function(j) {
        var g = j.getElementsByTagName("a"),
        f,
        e,
        h = [];
        e = g.length;
